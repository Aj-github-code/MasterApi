...
class TagController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $checkpostData = QNAMgmtTags::where(['slug'=> $input['slug']])->count();
        if($checkpostData > 0){
            $res = 'Update';
            ...
            $post = QNAMgmtTags::updateOrCreate(['slug'=>$postData['slug']],$postData);
    ...
    public function delete(Request $request){
        ...
        try{
            ...
            $delete = QNAMgmtTags::where('id', $postData['id'])->update(['is_active' => $is_active]);
